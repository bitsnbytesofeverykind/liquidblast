...
public class Username extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String prename = b.getString("PN");
                    ...
                    reference.child("ListUsers").child(name).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                reference.child("ListUsers").child(prename).setValue(null);
                                reference.child("Users").child(userID).child("myUsername").setValue(name);
                                reference.child("ListUsers").child(name).setValue(userID);
                                Intent intent = new Intent(Username.this, Online.class);
